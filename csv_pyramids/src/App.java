...
public class App {
    ...
    List<Pyramid> list = new ArrayList<Pyramid>(pyramids.stream().sorted(Comparator.comparingDouble(Pyramid::getHeight)).collect(Collectors.toList())) ;
    System.out.println("list of pyramids sorted wrt. height");
       ...
       Map<Object, List<Pyramid>> mapFunc = pyramids.stream().collect(Collectors.groupingBy(p->p.getModern_name()));
